if(pickedUp && !instance_exists(obj_diamondCutscene))
{
	draw_set_color(c_white);
	draw_set_font(fnt_small);
	draw_set_alpha(1);
	draw_text(camera_get_view_width(0)/2 - string_width("press \"Q\" to toggle colorblindness")/2, camera_get_view_height(0) - 64, "press \"Q\" to toggle colorblindness");
}
